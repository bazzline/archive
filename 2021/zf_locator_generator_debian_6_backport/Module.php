...
class Module implements AutoloaderProviderInterface, ConfigProviderInterface, ConsoleBannerProviderInterface, ConsoleUsageProviderInterface
{
    ...
    {
        return array(
            'net_bazzline locator generate [<locator_name>] [--verbose]'  => 'run generation of locator depending on your configuration',
            'net_bazzline locator list '  => 'list available locator with configuration path'
        );
    }
}
