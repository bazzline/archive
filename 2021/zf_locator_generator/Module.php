...
namespace NetBazzlineZfLocatorGenerator;
...
class Module implements AutoloaderProviderInterface, ConfigProviderInterface, ConsoleBannerProviderInterface, ConsoleUsageProviderInterface
{
    ...
    {
        return 'Net\Bazzline Zf Locator Generator - Version ' . self::VERSION;
    }
    ...
    {
        return array(
            'net_bazzline locator_generator generate [<locator_name>] [--verbose]'  => 'run generation of locator depending on your configuration',
            'net_bazzline locator_generator list '                                  => 'list available locator with configuration path'
        );
    }
}
