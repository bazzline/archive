...
[API](http://bazzline.net/10a549001924e2ce2e16f2c9fc1ad2873f281158/index.html) available at [bazzline.net](http://www.bazzline.net)

# History

* upcomming
    * @todo
* [1.2.2](https://github.com/bazzline/zf_console_helper/tree/1.2.2) - released at 18.12.2015
    * updated dependency
* [1.2.1](https://github.com/bazzline/zf_console_helper/tree/1.2.1) - released at 13.09.2015
    * updated dependency by setting zend framework version to minimum of 2.3
* [1.2.0](https://github.com/bazzline/zf_console_helper/tree/1.2.0) - released at 01.08.2015
    * added protected method "stopExecution" to prevent manipulating the now private property
    * updated php documentation
* [1.1.1](https://github.com/bazzline/zf_console_helper/tree/1.1.1) - released at 11.06.2015
    * moved documentation to [bazzline.net](https://www.bazzline.net)
* [1.1.0](https://github.com/bazzline/zf_console_helper/tree/1.1.0) - released at 04.06.2015
