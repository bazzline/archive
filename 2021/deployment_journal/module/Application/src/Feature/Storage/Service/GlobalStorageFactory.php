...
class GlobalStorageFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $storageClass   = $configuration['application']['storage']['global'][StorageInterface::class];
        $storageOptions = $configuration['application']['storage']['global']['options'];
